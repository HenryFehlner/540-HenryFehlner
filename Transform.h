...
public:
	Transform();
	Transform(float initialX, float initialY, float initialZ);
	~Transform();
	...
	void MoveAbsolute(DirectX::XMFLOAT3 pOffset);
	void MoveRelative(float x, float y, float z);
	void MoveRelative(DirectX::XMFLOAT3 pOffset);
	void Rotate(float pitch, float yaw, float roll);
	void Rotate(DirectX::XMFLOAT3 pRotation);
